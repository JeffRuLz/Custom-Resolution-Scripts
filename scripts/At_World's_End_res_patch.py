...
print("Hack method by Squ1zZy at the Widescreen Gaming Forum")
...
# Widescreen hack by Squ1zZy at the Widescreen Gaming Forum
# https://www.wsgf.org/dr/pirates-caribbean-worlds-end/en
#
# Replaces the in-game 640x480 resolution option.
# HUD elements do not scale.
# The in-game widescreen setting should remain off.
#
# At Worlds End.exe addresses:
# 0x35E6E - Screen Width - 640 [80 02]
# 0x35E74 - Screen Height - 480 [E0 01]
# 0x1E7C44 - Text string - '640 x 480'
#
# Squ1zZy's At Worlds End.exe addresses:
# 0x35E4E - Screen Width - 640 [80 02]
# 0x35E54 - Screen Height - 480 [E0 01]
# 0x1E7DA4 - Text string - '640 x 480'
